...
if __name__ == '__main__':
    ...
    parser.add_argument('--name',       nargs='?', default='coffee_cup',                                                      help='Name of the component')
    ...
    parser.add_argument('--obj-ids',    nargs='?', default='coffee_cup, bin',                                                      help='IDs of the objects, in the form: "1, 2" for two objects')
